...
const nearbyPlaces = [
  {
    ...
    description: 'A 500m - Principal shopping da região',
    distance: '2 min',
  },
  {
    icon: ShoppingCart,
    title: 'Praça Shopping',
    description: 'A 1,5km - Centro comercial',
    distance: '5 min',
  },
  {
    icon: Stethoscope,
  ...
  },
  {
    icon: Landmark,
    title: 'Bancos',
    description: 'Sicoob, Bradesco, Itaú, Caixa na região',
    distance: '2 min',
  },
  {
    icon: Building2,
    title: 'Clínicas Médicas',
    description: 'Diversas especialidades na Av. Marcolino',
    distance: '1 min',
  },
  {
    icon: Car,
